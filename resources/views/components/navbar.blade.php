<div x-data="{ open: false }" class="bg-white pt-6 px-6 w-1/5 h-screen font-bold">
    ...
    <div class="mt-8 flex flex-col gap-[300px]">
        ...
        <div x-cloak x-show="open" class="absolute top-[500px] ml-[120px] flex items-center gap-3 cursor-pointer bg-gray-100 py-3 px-2 rounded-lg">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form method="POST" action="{{ route('logout') }}" x-data>
                @csrf
                <button @click.prevent="$root.submit();" class="text-[#667085]">Logout</button>
            </form>
        </div>
    </div>
</div>